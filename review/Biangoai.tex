...
\vspace{1.5cm}
	...
	\vspace{2cm}
{
{\textbf {\MakeUppercase{\fontsize{17}{17}\selectfont{Phản biện đề tài Ứng dụng quản lý nhà cho thuê thông minh}}}}\\[3pt]
% {\textbf {\MakeUppercase{\fontsize{17}{17}\selectfont{Sử dụng thuật toán MUSIC trên thiết bị SDR}}}}\\[3pt]
}
\vspace{3cm}
\MakeUppercase{\textbf{\fontsize{14}{14}\selectfont{{Bài phản biện nhóm bộ môn Phát triển phần mềm di động}}}}\\[3pt]
