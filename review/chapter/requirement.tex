...
\item Tại Yêu cầu 06 (Quản lý hóa đơn): Họ bắt đầu bằng nỗi đau của người dùng: "Việc kiểm soát hóa đơn của từng phòng sẽ là một vấn đề nhức nhối, rất tốn công sức". Sau đó mới đưa ra yêu cầu như một giải pháp: "Yêu cầu này đặt ra có thể tối ưu hóa quá trình... giảm thiểu hóa công sức".
\item Tại Yêu cầu 09 (Chatbot): Họ nêu thực trạng "Các mâu thuẫn và thắc mắc liên quan đến luật... là thường xuyên" , từ đó mới đề xuất "Ứng dụng được đề xuất xây dựng với một AI Chatbot... nhằm hỗ trợ tư vấn".
\end{itemize}
