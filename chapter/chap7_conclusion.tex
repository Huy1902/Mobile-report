...
\begin{itemize}
	...
	\item Đánh giá của mô hình gợi ý đang ở độ đo trung bình và phương sai, chưa phải thanh đo chuẩn (cho hệ thống gợi ý và công bằng).
...
\begin{itemize}
	...
	\item Chuẩn hóa các thang đo để đánh giá mô hình gợi ý nhạc, bao gồm độ chính xác, độ đa dạng và công bằng.
